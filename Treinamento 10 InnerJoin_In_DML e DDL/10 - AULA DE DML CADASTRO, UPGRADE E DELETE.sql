...
+-----------+-----------------+------+--------------------------+-----------+--------------------------+-------------------+--------+-------------+-----------------+
|         1 | Max Diniz       | M    | maxdiniz@email.com       | 124564878 | Rua Oscar Freire         | Jardins           | SP     | CELULAR     | (11) 98765-4321 |
|         1 | Max Diniz       | M    | maxdiniz@email.com       | 124564878 | Rua Oscar Freire         | Jardins           | SP     | RESIDENCIAL | (21) 2468-1357  |
|         1 | Max Diniz       | M    | maxdiniz@email.com       | 124564878 | Rua Oscar Freire         | Jardins           | SP     | COMERCIAL   | (11) 1234-5678  |
|         2 | Ana Silva       | F    | anasilva@email.com       | 987654321 | Rua Marquês de Abrantes  | Flamengo          | RJ     | CELULAR     | (21) 99876-5432 |
|         2 | Ana Silva       | F    | anasilva@email.com       | 987654321 | Rua Marquês de Abrantes  | Flamengo          | RJ     | RESIDENCIAL | (21) 3579-2468  |
|         3 | João Pedro      | M    | joaopedro@email.com      | 456789123 | Avenida Atlântica        | Copacabana        | RJ     | CELULAR     | (11) 98765-1234 |
|         3 | João Pedro      | M    | joaopedro@email.com      | 456789123 | Avenida Atlântica        | Copacabana        | RJ     | RESIDENCIAL | (31) 3698-1357  |
|         4 | Mariana Lima    | F    | marianalima@email.com    | 789123456 | Rua Padre Eustáquio      | Padre Eustáquio   | MG     | CELULAR     | (11) 98765-8765 |
|         4 | Mariana Lima    | F    | marianalima@email.com    | 789123456 | Rua Padre Eustáquio      | Padre Eustáquio   | MG     | RESIDENCIAL | (31) 4567-2468  |
|         5 | Lucas Santos    | M    | lucassantos@email.com    | 321654987 | Rua Guaicurus            | Centro            | SP     | CELULAR     | (11) 98765-5678 |
|         5 | Lucas Santos    | M    | lucassantos@email.com    | 321654987 | Rua Guaicurus            | Centro            | SP     | RESIDENCIAL | (41) 3698-1357  |
|         5 | Lucas Santos    | M    | lucassantos@email.com    | 321654987 | Rua Guaicurus            | Centro            | SP     | COMERCIAL   | (11) 98765-4321 |
|         6 | Juliana Almeida | F    | julianaalmeida@email.com | 159753456 | Rua XV de Novembro       | Centro            | PR     | CELULAR     | (11) 99876-5432 |
|         6 | Juliana Almeida | F    | julianaalmeida@email.com | 159753456 | Rua XV de Novembro       | Centro            | PR     | RESIDENCIAL | (41) 3579-2468  |
|         7 | Rodrigo Silva   | M    | rodrigosilva@email.com   | 147258369 | Rua da Praia             | Centro Histórico  | RS     | CELULAR     | (11) 98765-1234 |
+-----------+-----------------+------+--------------------------+-----------+--------------------------+-------------------+--------+-------------+-----------------+
...
/* IDS E EMAIL DAS MULHERES QUE MOREM NO CNETRO DO RIO DE JANEIRO QUE NÃO POSSUI CELULAR*/
...
INNER JOIN TELEFONE T
ON C.IDCLIENTE = T.ID_CLIENTE
WHERE ESTADO ='RJ' AND BAIRRO ='Centro';

-- filtrando primeiro as informações
+-----------+--------------+------+-----------------------+-----------+-----------------------+--------+--------+-----------+----------------+
| IDCLIENTE | NOME         | SEXO | EMAIL                 | CPF       | RUA                   | BAIRRO | ESTADO | TIPO      | NUMERO         |
+-----------+--------------+------+-----------------------+-----------+-----------------------+--------+--------+-----------+----------------+
|        12 | Souza Camila | M    | souzacamila@email.com | 576159852 | Rua Marechal Floriano | Centro | RJ     | CELULAR   | (11) 1345-9465 |
|        12 | Souza Camila | M    | souzacamila@email.com | 576159852 | Rua Marechal Floriano | Centro | RJ     | COMERCIAL | (11) 1593-9514 |
+-----------+--------------+------+-----------------------+-----------+-----------------------+--------+--------+-----------+----------------+
...
INNER JOIN TELEFONE T
ON C.IDCLIENTE = T.ID_CLIENTE
WHERE SEXO ='F' AND BAIRRO ='CENTRO'
OR (TIPO ='RESIDENCIAL' OR TIPO='COMERCIAL');
...
SELECT C.IDCLIENTE,C.NOME,C.EMAIL,E.ESTADO,T.NUMERO
FROM CLIENTE C
INNER JOIN ENDERECO E
ON C.IDCLIENTE = E.ID_CLIENTE
INNER JOIN TELEFONE T
...
+-----------+--------------+-----------------------+--------+-----------------+
| IDCLIENTE | NOME         | EMAIL                 | ESTADO | NUMERO          |
+-----------+--------------+-----------------------+--------+-----------------+
|         2 | Ana Silva    | anasilva@email.com    | RJ     | (21) 99876-5432 |
|         3 | João Pedro   | joaopedro@email.com   | RJ     | (11) 98765-1234 |
|        12 | Souza Camila | souzacamila@email.com | RJ     | (11) 1345-9465  |
+-----------+--------------+-----------------------+--------+-----------------

/* PARA UMA CAMPANHA DE PRODUTOS DE BELEZA, O COMERCIAL SOLICITOU UM RELATÓRIO COM O NOME, EMAIL E TELEFONE CELULAR DAS MULHERES
